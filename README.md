...
1. **启动LM Studio** 并加载翻译模型
   - 推荐模型：`sakura-galtransl-7b-v3.7`
   - 确保模型已完全加载到内存
...
**重要提示**：
- **小参数模型（1.5B-1.8B）容易出现翻译失败**，直接返回日语原文
- **建议使用7B以上参数模型**确保翻译质量
- sakura-galtransl系列针对日中翻译优化，效果最佳
